...
void menuOrdenarCaracteresDoble(ListaDoble<string>& lista);
                ...
                switch (currentSelection) {
                    ...
                    case 1: { 
                        if (lista.listaVacia()) {
                            ...
                            numCedula = lista.ingresarCedula("Ingrese el numero de cedula a buscar");
                            if (!lista.esNumeroCedulaValido(numCedula)) {
                    ...
                    case 7: { 
                        menuOrdenarCaracteresDoble(lista);
                        break;
                    }
                    case 8: 
