...
void ListaCircular<T>::ordenar(Compare comp) {
    Ordenador<NodoCircular<T>>::ordenarPorSeleccion(primero, comp);
    guardarEnArchivo();
}

template <typename T>
void ListaCircular<T>::ordenarCaracteresEnAtributo(const std::string& atributo) {
    Ordenador<NodoCircular<T>>::ordenarCaracteresEnAtributo(primero, atributo);
...
void ListaCircular<T>::guardarCaracteresOrdenadosEnArchivo(const std::string& atributo) {
    Ordenador<NodoCircular<T>>::guardarCaracteresEnArchivo(primero, "usuariosCaracteres.txt", atributo);
}
