...
void ListaSimple::ordenar(const function<bool(Persona*, Persona*)>& comparar) {
    Sorter<Persona, Nodo>::shellSort(primero, comparar);
...
void ListaSimple::ordenarPorCaracter() {
    ...
    while (actual != nullptr) {
        ...
        Sorter<char, Nodo>::shellSortString(primerNombre);
        Sorter<char, Nodo>::shellSortString(segundoNombre);
        Sorter<char, Nodo>::shellSortString(apellido);
